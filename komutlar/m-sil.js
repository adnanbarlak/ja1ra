...
if(isNaN(args[0])) return message.channel.send('Lütfen Bir Sayı Giriniz.');
if(args[0] > 100) {
...
if(sayı <= 0) return message.channel.send("Discord Yüzünden 14 Günden Eski Mesajları Silemiyorum.");
